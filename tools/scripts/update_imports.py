#!/usr/bin/env python
"""
Script to update import statements to reflect the new directory structure.

This script scans Python files for import statements that use the old directory
structure and updates them to use the new structure.
"""
...
IMPORT_MAPPINGS = {
    ...
    r'from backtester\.backtest\.backtester import Backtester': 'from backtester.core.engine import Backtester',
    r'from backtester\.backtest import BacktestResults': 'from backtester.core import BacktestResults',
    r'from backtester\.backtest\.results import BacktestResults': 'from backtester.core.results import BacktestResults',
...
def main():
    ...
    print(f"Updating import statements in {directory} to reflect the new directory structure...")
    
    total_files, modified_files = process_directory(directory)
    
    print(f"Update complete. Processed {total_files} files, modified {modified_files} files.")
